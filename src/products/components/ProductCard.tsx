...
export const ProductCard = ({ id, name, price, rating, image }: Props) => {
    ...
    return (
        <>
            <div className="bg-white shadow rounded-lg max-w-xs p-4 dark:bg-gray-800 ">
                {/* Product Image */}
                <div className="p-2">
                    <Image
                        width={500}
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex">
                            ...
                            <button
                                ...
                                className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-700 dark:focus:ring-red-800"
                            >
